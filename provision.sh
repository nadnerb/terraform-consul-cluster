...
# It will be replaced in future so that it can run many different Terraform
# stacks. A better solution would be for Terraform to support multiple environments.
#
...
APP_NAME=terraform-consul-stack
